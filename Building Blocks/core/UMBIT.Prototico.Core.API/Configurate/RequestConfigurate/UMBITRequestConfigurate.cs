...
namespace UMBIT.Prototico.Core.API.Configurate.RequestConfigurate
{
    ...
    {
        public static IServiceCollection AddUMBITRequestConfigurate<TI, T>(this IServiceCollection services, IConfiguration configuration, string baseAdressSection)
